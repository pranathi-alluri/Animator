...
public class SimpleKeyframeTest {
  ...
  public void testToString() {
    ...
    Keyframe kf1 = new SimpleKeyframe(shape1, 0);
    Keyframe kf2 = new SimpleKeyframe(shape2, 40);
    assertEquals(kf1.getDescription(kf2), "From time 0 to 40, Oval moves from (10.0,10.0) " +
            "to (50.0,90.0), scales from 10.0x10.0 to 30.0x10.0,  and the color changes from " +
