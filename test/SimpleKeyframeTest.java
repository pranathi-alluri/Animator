...
public class SimpleKeyframeTest {
  ...
  public void testIllegalTimeInterpolate() {
    Keyframe kf = new SimpleKeyframe(this.shape, this.time);
    Shape shape2 = new SimpleRectangle("red square", 30, 30, new Color(255, 0, 0), 40, 10);
  ...
  public void testIllegalNameInterpolate() {
    Keyframe kf = new SimpleKeyframe(this.shape, this.time);
    Shape shape2 = new SimpleRectangle("red rectangle", 30, 30, new Color(255, 0, 0), 40, 10);
    Keyframe kf2 = new SimpleKeyframe(shape2, 40);
  ...
  public void testIllegalShapeInterpolate() {
    Keyframe kf = new SimpleKeyframe(this.shape, this.time);
    Shape shape2 = new SimpleOval("red square", 30, 30, new Color(255, 0, 0), 40, 10);
    Keyframe kf2 = new SimpleKeyframe(shape2, 40);
    kf.interpolate(kf2, 30);
  }
  ...
  public void testInterpolate() {
    ...
    Shape shape2 = new SimpleRectangle("red square", 30, 30, new Color(255, 0, 0), 40, 10);
    Keyframe kf2 = new SimpleKeyframe(shape2, 40);
    Shape interpolatedShape = new SimpleRectangle("red square", 25, 25, new Color(255, 0, 0), 30, 15);
  ...
  public void testInterpolate2() {
    ...
    Shape interpolatedShape = new SimpleOval("Oval", 20, 30, new Color(25, 175, 125), 10, 15);
