...
import cs3500.animator.model.AnimationModelFactory;
import cs3500.animator.model.AnimationModelType;
...
/**
 * Abstract testing class for AnimationModel.
 */
public abstract class AbstractAnimationModelTest {
   ...
   */
  public AbstractAnimationModelTest(AnimationModelType type) {
    ...
    this.sam = AnimationModelFactory.getModel(type);
